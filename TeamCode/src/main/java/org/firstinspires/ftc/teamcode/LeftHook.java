 ...
 */
@Autonomous(name = "LeftHook", group = "Sensor")
//@Disabled
public class LeftHook extends LinearOpMode {
    // Create an instance of the sensor
    public SparkFunOTOS myOtos;
    DcMotor spin, spin2;
    MotorEx lbMotor, lfMotor, rbMotor, rfMotor;
    double speedtoggle = 0.5;
    double tarposx = 38; //reversed values
    double tarposy = 0.6;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            if(stopwatches[0].isRunning()){ //multi-pos w interrupts based on guava stopwatch
                ...
                if(stopwatches[0].elapsed(TimeUnit.MILLISECONDS) > 21000 && stopwatches[0].elapsed(TimeUnit.MILLISECONDS) < 30000){
                    tarposx = 95;
                    allowprimx = true;
                }
